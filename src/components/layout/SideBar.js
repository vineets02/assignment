...
function SideBar() {
  ...
  return (
    <div>
      <section className="flex gap-80 sm:h-[580px] sm:absolute z-50">
        <div
          className={`bg-white  min-h-screen    ${
            open ? "w-80" : "w-16 shadow-lg  shadow-slate-200"
        ...
        >
          ...
          <div className="flex gap-x-4 items-center">
            <h1
              className={`text-gray-600 origin-left font-medium text-xl duration-200 ${
                !open && "scale-0"
              }`}
            ></h1>
          </div>
